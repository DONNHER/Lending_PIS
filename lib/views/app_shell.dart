import 'package:capstone_application/views/consignees_page.dart';
import 'package:capstone_application/views/consignment_products_page.dart';
import 'package:capstone_application/views/grocery_products_page.dart';
...
class _AppShellState extends State<AppShell> {
  ...
  Widget _buildDrawer(
    ...
    if (drawerItems.isEmpty) return const SizedBox.shrink();
  ...
  Widget _buildPage(List<NavItemModel> items, int selectedIndex) {
    ...
    switch (route) {
      ...
      case '/consignment-products':
        return const ConsignmentProductsPage();
      case '/grocery-products':
        return const GroceryProductsPage();
      case '/consignees':
        return const ConsigneesPage();
      default:
